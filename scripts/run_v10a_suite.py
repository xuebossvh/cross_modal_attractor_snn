"""Run v10a training, optionally followed by the first three ablations.
...
from make_v10a_ablations import write_variants
...
def main():
    ...
    ap.add_argument("--with_ablations", action="store_true",
                    help="Run the three predefined v10a ablations after main training.")
