"""Generate temporary configs for the first three v9b ablations.

The official branch config remains configs/v9b.yaml. This script writes
experiment configs under outputs/ablations_v9b/configs/ so the repository does
...
ABLATION_ROOT = PROJECT_ROOT / "outputs" / "ablations_v9b" / "configs"
...
def build_variants(base):
    ...
    yield "v9b_ablate_A_simultaneous", _variant(base, "v9b_ablate_A_simultaneous", {
        "detail_conditioning": {
            "enabled": True,
            "detach": False,
    ...
    yield "v9b_ablate_B_detach_false_only", _variant(base, "v9b_ablate_B_detach_false_only", {
        "detail_conditioning": {
            "enabled": True,
            "detach": False,
            "detach_value_for_recon": False,
    ...
    yield "v9b_ablate_C_pretrain_only", _variant(base, "v9b_ablate_C_pretrain_only", {
        "detail_conditioning": {
            "enabled": True,
            "detach": True,
            "detach_value_for_recon": False,
