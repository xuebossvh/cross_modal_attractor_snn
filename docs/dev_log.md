...
���ζ�ȡ��������ɵ� v11g ���в��δ�Ѳ��︴�ƽ�����ֿ⡣��ʵ��� no-causal ��ѵ����־���� `epoch 29`������� 30 �֣�control ʹ�ö���� `v11e_control`���� checkpoint SHA256 Ϊ `5a792f10e57a95947c8e51bd915b09897baee01475103010826f25275b71501b`��main/no-causal checkpoint SHA256 �ֱ�Ϊ `2fa5866322841246c335ccd4916fa7efc9bd3fdfd05de53cf8c374cd4b7adb9f` �� `1bafc57e9f1c4064373ca3a0522dd6afd2952a73297d6883d52d3bf9cad2c307`��

fixed �� legacy_random ��ʹ�� severity=0.4��normal ÿ�� cue ����ͳ��Ϊ n=10000������ normal ����ͬһ cue �� CSV �п��� family ��������ƽ����NA ��ʾ�����û�ԭʼ CSV δ���㡣Cross-Key sweep �Ĳ������ͳ����Ч n=9996��������ԭʼ�� n ��Ϊ׼������֤�ݣ�`v11g_outputs/outputs/outputs_v11g*/tables/`����Ӧ `logs/` �� `figures/`��

### Normal����ʵ�顢�� cue��ȫ������ָ��

`metrics` ���� normal CSV �����з� NA �ֶΡ�

#### fixed_mask
| ʵ�� | cue | n | metrics |
|---|---|---:|---|
| main | `clean_aud_only` | 10000 | acc=0.9883; aud_mse=0.00364809; aud_ssim=0.911157; content_aud_normal_acc=0.96; content_img_normal_acc=0.9809; img_coarse_masked_mse=0.0020525; img_masked_l1=0.00744241; img_masked_mse=0.0020525; img_mse=0.0020525; pair_l2=0.286325; pix_var=0.0459208; psnr=37.1925; ssim=0.985947 |
| main | `clean_img_only` | 10000 | acc=0.977; aud_masked_l1=0.00361639; aud_masked_mse=0.000294015; aud_mse=0.000294015; aud_ssim=0.965833; content_aud_normal_acc=0.942; content_img_normal_acc=0.9682; img_mse=0.00977739; pair_l2=0.340023; pix_var=0.0593863; psnr=20.7714; ssim=0.942646 |
| main | `clean_both` | 10000 | acc=0.9918; aud_mse=0.00364344; aud_ssim=0.911253; content_aud_normal_acc=0.9604; content_img_normal_acc=0.9779; img_mse=0.00973233; pair_l2=0.338677; pix_var=0.0588506; psnr=20.7941; ssim=0.942685 |
| main | `clean_img_corrupt_aud` | 10000 | acc=0.98934; aud_masked_l1=0.0306214; aud_masked_mse=0.0101281; aud_mse=0.00592156; aud_ssim=0.809892; aud_visible_l1=0.0134368; aud_visible_mse=0.0031434; content_aud_normal_acc=0.88936; content_img_normal_acc=0.9752; img_mse=0.00979025; pair_l2=0.339469; pix_var=0.0593206; psnr=20.7683; ssim=0.942597 |
| main | `corrupt_aud_only` | 10000 | acc=0.84572; aud_masked_l1=0.0310116; aud_masked_mse=0.011079; aud_mse=0.0062897; aud_ssim=0.804689; aud_visible_l1=0.0134382; aud_visible_mse=0.00314286; content_aud_normal_acc=0.806; content_img_normal_acc=0.83066; img_coarse_masked_mse=0.0127563; img_masked_l1=0.025332; img_masked_mse=0.0127563; img_mse=0.0127563; pair_l2=0.263287; pix_var=0.0395815; psnr=30.7392; ssim=0.885779 |
| main | `corrupt_img_clean_aud` | 10000 | acc=0.99144; aud_mse=0.00364682; aud_ssim=0.911207; content_aud_normal_acc=0.95968; content_img_normal_acc=0.9675; img_coarse_masked_mse=0.0558592; img_coarse_visible_mse=0.0307315; img_masked_l1=0.0627542; img_masked_mse=0.0252635; img_mse=0.00732053; img_visible_l1=8.09067e-05; img_visible_mse=8.09049e-09; pair_l2=0.343979; pix_var=0.0606579; psnr=23.0923; ssim=0.957235 |
| main | `corrupt_img_only` | 10000 | acc=0.92028; aud_masked_l1=0.00542768; aud_masked_mse=0.000670174; aud_mse=0.000670174; aud_ssim=0.91639; content_aud_normal_acc=0.83468; content_img_normal_acc=0.95514; img_coarse_masked_mse=0.0563251; img_coarse_visible_mse=0.0312344; img_masked_l1=0.063682; img_masked_mse=0.0266619; img_mse=0.00768047; img_visible_l1=8.09067e-05; img_visible_mse=8.09049e-09; pair_l2=0.344495; pix_var=0.060839; psnr=22.9047; ssim=0.955151 |
| main | `corrupt_both` | 10000 | acc=0.97536; aud_masked_l1=0.0309324; aud_masked_mse=0.0104162; aud_mse=0.00604081; aud_ssim=0.80761; aud_visible_l1=0.0133857; aud_visible_mse=0.0031369; content_aud_normal_acc=0.87022; content_img_normal_acc=0.96266; img_coarse_masked_mse=0.0549893; img_coarse_visible_mse=0.0305506; img_masked_l1=0.0628138; img_masked_mse=0.0253559; img_mse=0.00737081; img_visible_l1=8.0887e-05; img_visible_mse=8.08852e-09; pair_l2=0.345074; pix_var=0.0608768; psnr=23.058; ssim=0.957016 |
| control | `clean_aud_only` | 10000 | acc=0.9883; aud_mse=0.00364809; aud_ssim=0.911157; content_aud_normal_acc=0.96; content_img_normal_acc=0.9771; img_coarse_masked_mse=0.00208493; img_masked_l1=0.00715352; img_masked_mse=0.00208493; img_mse=0.00208493; pair_l2=0.287549; pix_var=0.0462917; psnr=37.6247; ssim=0.985595 |
| control | `clean_img_only` | 10000 | acc=0.977; aud_masked_l1=0.00346958; aud_masked_mse=0.000289205; aud_mse=0.000289205; aud_ssim=0.965964; content_aud_normal_acc=0.9432; content_img_normal_acc=0.9682; img_mse=0.00977739; pair_l2=0.340023; pix_var=0.0593863; psnr=20.7714; ssim=0.942646 |
| control | `clean_both` | 10000 | acc=0.9918; aud_mse=0.00364344; aud_ssim=0.911253; content_aud_normal_acc=0.9604; content_img_normal_acc=0.9779; img_mse=0.00973233; pair_l2=0.338677; pix_var=0.0588506; psnr=20.7941; ssim=0.942685 |
| control | `clean_img_corrupt_aud` | 10000 | acc=0.98934; aud_masked_l1=0.0305858; aud_masked_mse=0.0105994; aud_mse=0.00609738; aud_ssim=0.80759; aud_visible_l1=0.0134368; aud_visible_mse=0.0031434; content_aud_normal_acc=0.8897; content_img_normal_acc=0.9752; img_mse=0.00979025; pair_l2=0.339469; pix_var=0.0593206; psnr=20.7683; ssim=0.942597 |
| control | `corrupt_aud_only` | 10000 | acc=0.84572; aud_masked_l1=0.0310116; aud_masked_mse=0.011079; aud_mse=0.0062897; aud_ssim=0.804689; aud_visible_l1=0.0134382; aud_visible_mse=0.00314286; content_aud_normal_acc=0.806; content_img_normal_acc=0.82882; img_coarse_masked_mse=0.0132116; img_masked_l1=0.0250604; img_masked_mse=0.0132116; img_mse=0.0132116; pair_l2=0.265096; pix_var=0.0400525; psnr=30.8943; ssim=0.877703 |
| control | `corrupt_img_clean_aud` | 10000 | acc=0.99144; aud_mse=0.00364682; aud_ssim=0.911207; content_aud_normal_acc=0.95968; content_img_normal_acc=0.9672; img_coarse_masked_mse=0.0548339; img_coarse_visible_mse=0.0307315; img_masked_l1=0.0622836; img_masked_mse=0.025918; img_mse=0.00750159; img_visible_l1=8.09067e-05; img_visible_mse=8.09049e-09; pair_l2=0.345199; pix_var=0.0610726; psnr=22.9938; ssim=0.956305 |
| control | `corrupt_img_only` | 10000 | acc=0.92028; aud_masked_l1=0.00529486; aud_masked_mse=0.00066839; aud_mse=0.00066839; aud_ssim=0.916781; content_aud_normal_acc=0.83518; content_img_normal_acc=0.95514; img_coarse_masked_mse=0.0563251; img_coarse_visible_mse=0.0312344; img_masked_l1=0.063682; img_masked_mse=0.0266619; img_mse=0.00768047; img_visible_l1=8.09067e-05; img_visible_mse=8.09049e-09; pair_l2=0.344495; pix_var=0.060839; psnr=22.9047; ssim=0.955151 |
| control | `corrupt_both` | 10000 | acc=0.97536; aud_masked_l1=0.0309396; aud_masked_mse=0.0107748; aud_mse=0.00617585; aud_ssim=0.805881; aud_visible_l1=0.0133857; aud_visible_mse=0.0031369; content_aud_normal_acc=0.87012; content_img_normal_acc=0.96178; img_coarse_masked_mse=0.0546859; img_coarse_visible_mse=0.0305506; img_masked_l1=0.0622678; img_masked_mse=0.0259124; img_mse=0.00751963; img_visible_l1=8.0887e-05; img_visible_mse=8.08852e-09; pair_l2=0.34565; pix_var=0.0610828; psnr=22.976; ssim=0.956189 |
| no_causal | `clean_aud_only` | 10000 | acc=0.9883; aud_mse=0.00364809; aud_ssim=0.911157; content_aud_normal_acc=0.96; content_img_normal_acc=0.9771; img_coarse_masked_mse=0.00208492; img_masked_l1=0.00749103; img_masked_mse=0.00208492; img_mse=0.00208492; pair_l2=0.287506; pix_var=0.0462463; psnr=36.8851; ssim=0.985614 |
| no_causal | `clean_img_only` | 10000 | acc=0.977; aud_masked_l1=0.00356523; aud_masked_mse=0.00029628; aud_mse=0.00029628; aud_ssim=0.966043; content_aud_normal_acc=0.9448; content_img_normal_acc=0.9682; img_mse=0.00977739; pair_l2=0.340023; pix_var=0.0593863; psnr=20.7714; ssim=0.942646 |
| no_causal | `clean_both` | 10000 | acc=0.9918; aud_mse=0.00364344; aud_ssim=0.911253; content_aud_normal_acc=0.9604; content_img_normal_acc=0.9779; img_mse=0.00973233; pair_l2=0.338677; pix_var=0.0588506; psnr=20.7941; ssim=0.942685 |
| no_causal | `clean_img_corrupt_aud` | 10000 | acc=0.98934; aud_masked_l1=0.0307329; aud_masked_mse=0.0103113; aud_mse=0.00599072; aud_ssim=0.810125; aud_visible_l1=0.0134368; aud_visible_mse=0.0031434; content_aud_normal_acc=0.89218; content_img_normal_acc=0.9752; img_mse=0.00979025; pair_l2=0.339469; pix_var=0.0593206; psnr=20.7683; ssim=0.942597 |
| no_causal | `corrupt_aud_only` | 10000 | acc=0.84572; aud_masked_l1=0.0310116; aud_masked_mse=0.011079; aud_mse=0.0062897; aud_ssim=0.804689; aud_visible_l1=0.0134382; aud_visible_mse=0.00314286; content_aud_normal_acc=0.806; content_img_normal_acc=0.82942; img_coarse_masked_mse=0.012351; img_masked_l1=0.0257939; img_masked_mse=0.012351; img_mse=0.012351; pair_l2=0.262683; pix_var=0.0394883; psnr=30.4576; ssim=0.891893 |
| no_causal | `corrupt_img_clean_aud` | 10000 | acc=0.99144; aud_mse=0.00364682; aud_ssim=0.911207; content_aud_normal_acc=0.95968; content_img_normal_acc=0.96754; img_coarse_masked_mse=0.054915; img_coarse_visible_mse=0.0307315; img_masked_l1=0.0620013; img_masked_mse=0.0254411; img_mse=0.00739011; img_visible_l1=8.09067e-05; img_visible_mse=8.09049e-09; pair_l2=0.344517; pix_var=0.0608461; psnr=23.0675; ssim=0.95685 |
| no_causal | `corrupt_img_only` | 10000 | acc=0.92028; aud_masked_l1=0.00533035; aud_masked_mse=0.00067383; aud_mse=0.00067383; aud_ssim=0.917291; content_aud_normal_acc=0.84086; content_img_normal_acc=0.95514; img_coarse_masked_mse=0.0563251; img_coarse_visible_mse=0.0312344; img_masked_l1=0.063682; img_masked_mse=0.0266619; img_mse=0.00768047; img_visible_l1=8.09067e-05; img_visible_mse=8.09049e-09; pair_l2=0.344495; pix_var=0.060839; psnr=22.9047; ssim=0.955151 |
| no_causal | `corrupt_both` | 10000 | acc=0.97536; aud_masked_l1=0.0310156; aud_masked_mse=0.0105583; aud_mse=0.00609481; aud_ssim=0.807901; aud_visible_l1=0.0133857; aud_visible_mse=0.0031369; content_aud_normal_acc=0.8715; content_img_normal_acc=0.96258; img_coarse_masked_mse=0.0542359; img_coarse_visible_mse=0.0305506; img_masked_l1=0.0625221; img_masked_mse=0.025528; img_mse=0.00743137; img_visible_l1=8.0887e-05; img_visible_mse=8.08852e-09; pair_l2=0.345329; pix_var=0.0609684; psnr=23.0288; ssim=0.956679 |
#### legacy_random
| ʵ�� | cue | n | metrics |
|---|---|---:|---|
| main | `clean_aud_only` | 10000 | acc=0.9883; aud_mse=0.00364809; aud_ssim=0.911157; content_aud_normal_acc=0.96; content_img_normal_acc=0.9809; img_coarse_masked_mse=0.0020525; img_masked_l1=0.00744241; img_masked_mse=0.0020525; img_mse=0.0020525; pair_l2=0.284642; pix_var=0.0459208; psnr=37.1925; ssim=0.985947 |
| main | `clean_img_only` | 10000 | acc=0.977; aud_masked_l1=0.00361639; aud_masked_mse=0.000294015; aud_mse=0.000294015; aud_ssim=0.965833; content_aud_normal_acc=0.942; content_img_normal_acc=0.9682; img_mse=0.00977739; pair_l2=0.339948; pix_var=0.0593863; psnr=20.7714; ssim=0.942646 |
| main | `clean_both` | 10000 | acc=0.9918; aud_mse=0.00364344; aud_ssim=0.911253; content_aud_normal_acc=0.9604; content_img_normal_acc=0.9779; img_mse=0.00973233; pair_l2=0.33994; pix_var=0.0588506; psnr=20.7941; ssim=0.942685 |
| main | `clean_img_corrupt_aud` | 10000 | acc=0.9896; aud_masked_l1=0.0291909; aud_masked_mse=0.00948602; aud_mse=0.00570683; aud_ssim=0.818191; aud_visible_l1=0.0137003; aud_visible_mse=0.00320552; content_aud_normal_acc=0.8974; content_img_normal_acc=0.975; img_mse=0.00978341; pair_l2=0.341653; pix_var=0.0592846; psnr=20.7705; ssim=0.942602 |
| main | `corrupt_aud_only` | 10000 | acc=0.8579; aud_masked_l1=0.0295669; aud_masked_mse=0.0103806; aud_mse=0.00605548; aud_ssim=0.813113; aud_visible_l1=0.0137038; aud_visible_mse=0.00320732; content_aud_normal_acc=0.8177; content_img_normal_acc=0.8425; img_coarse_masked_mse=0.0118108; img_masked_l1=0.0238485; img_masked_mse=0.0118108; img_mse=0.0118108; pair_l2=0.272443; pix_var=0.040548; psnr=31.1186; ssim=0.894453 |
| main | `corrupt_img_clean_aud` | 10000 | acc=0.9916; aud_mse=0.00364718; aud_ssim=0.911193; content_aud_normal_acc=0.96; content_img_normal_acc=0.9673; img_coarse_masked_mse=0.0596316; img_coarse_visible_mse=0.0286298; img_masked_l1=0.0675479; img_masked_mse=0.0274295; img_mse=0.00720657; img_visible_l1=8.14308e-05; img_visible_mse=8.14291e-09; pair_l2=0.345189; pix_var=0.0608294; psnr=23.0715; ssim=0.95761 |
| main | `corrupt_img_only` | 10000 | acc=0.9236; aud_masked_l1=0.00526462; aud_masked_mse=0.000629427; aud_mse=0.000629427; aud_ssim=0.921352; content_aud_normal_acc=0.8463; content_img_normal_acc=0.9549; img_coarse_masked_mse=0.0607087; img_coarse_visible_mse=0.0291008; img_masked_l1=0.0689266; img_masked_mse=0.0292326; img_mse=0.00761429; img_visible_l1=8.14308e-05; img_visible_mse=8.14291e-09; pair_l2=0.345536; pix_var=0.0609478; psnr=22.8654; ssim=0.955219 |
| main | `corrupt_both` | 10000 | acc=0.9728; aud_masked_l1=0.0285169; aud_masked_mse=0.00958116; aud_mse=0.00580407; aud_ssim=0.822269; aud_visible_l1=0.0141385; aud_visible_mse=0.00331514; content_aud_normal_acc=0.8746; content_img_normal_acc=0.9633; img_coarse_masked_mse=0.0546358; img_coarse_visible_mse=0.0306974; img_masked_l1=0.0632741; img_masked_mse=0.0256151; img_mse=0.0075641; img_visible_l1=8.09326e-05; img_visible_mse=8.09307e-09; pair_l2=0.344233; pix_var=0.0606584; psnr=22.833; ssim=0.955441 |
| control | `clean_aud_only` | 10000 | acc=0.9883; aud_mse=0.00364809; aud_ssim=0.911157; content_aud_normal_acc=0.96; content_img_normal_acc=0.9771; img_coarse_masked_mse=0.00208493; img_masked_l1=0.00715352; img_masked_mse=0.00208493; img_mse=0.00208493; pair_l2=0.285884; pix_var=0.0462917; psnr=37.6247; ssim=0.985595 |
| control | `clean_img_only` | 10000 | acc=0.977; aud_masked_l1=0.00346958; aud_masked_mse=0.000289205; aud_mse=0.000289205; aud_ssim=0.965964; content_aud_normal_acc=0.9432; content_img_normal_acc=0.9682; img_mse=0.00977739; pair_l2=0.339948; pix_var=0.0593863; psnr=20.7714; ssim=0.942646 |
| control | `clean_both` | 10000 | acc=0.9918; aud_mse=0.00364344; aud_ssim=0.911253; content_aud_normal_acc=0.9604; content_img_normal_acc=0.9779; img_mse=0.00973233; pair_l2=0.33994; pix_var=0.0588506; psnr=20.7941; ssim=0.942685 |
| control | `clean_img_corrupt_aud` | 10000 | acc=0.9896; aud_masked_l1=0.0291688; aud_masked_mse=0.00992893; aud_mse=0.0058725; aud_ssim=0.816051; aud_visible_l1=0.0137003; aud_visible_mse=0.00320552; content_aud_normal_acc=0.8983; content_img_normal_acc=0.975; img_mse=0.00978341; pair_l2=0.341653; pix_var=0.0592846; psnr=20.7705; ssim=0.942602 |
| control | `corrupt_aud_only` | 10000 | acc=0.8579; aud_masked_l1=0.0295669; aud_masked_mse=0.0103806; aud_mse=0.00605548; aud_ssim=0.813113; aud_visible_l1=0.0137038; aud_visible_mse=0.00320732; content_aud_normal_acc=0.8177; content_img_normal_acc=0.8409; img_coarse_masked_mse=0.0122087; img_masked_l1=0.0235701; img_masked_mse=0.0122087; img_mse=0.0122087; pair_l2=0.274684; pix_var=0.0411256; psnr=31.2755; ssim=0.887254 |
| control | `corrupt_img_clean_aud` | 10000 | acc=0.9916; aud_mse=0.00364718; aud_ssim=0.911193; content_aud_normal_acc=0.96; content_img_normal_acc=0.9669; img_coarse_masked_mse=0.0589041; img_coarse_visible_mse=0.0286298; img_masked_l1=0.0672297; img_masked_mse=0.0282621; img_mse=0.00741694; img_visible_l1=8.14308e-05; img_visible_mse=8.14291e-09; pair_l2=0.346267; pix_var=0.0611931; psnr=22.956; ssim=0.956508 |
| control | `corrupt_img_only` | 10000 | acc=0.9236; aud_masked_l1=0.00513334; aud_masked_mse=0.000627487; aud_mse=0.000627487; aud_ssim=0.921694; content_aud_normal_acc=0.8427; content_img_normal_acc=0.9549; img_coarse_masked_mse=0.0607087; img_coarse_visible_mse=0.0291008; img_masked_l1=0.0689266; img_masked_mse=0.0292326; img_mse=0.00761429; img_visible_l1=8.14308e-05; img_visible_mse=8.14291e-09; pair_l2=0.345536; pix_var=0.0609478; psnr=22.8654; ssim=0.955219 |
| control | `corrupt_both` | 10000 | acc=0.9728; aud_masked_l1=0.0285437; aud_masked_mse=0.00991035; aud_mse=0.0059267; aud_ssim=0.820633; aud_visible_l1=0.0141385; aud_visible_mse=0.00331514; content_aud_normal_acc=0.8731; content_img_normal_acc=0.9634; img_coarse_masked_mse=0.0543754; img_coarse_visible_mse=0.0306974; img_masked_l1=0.0627845; img_masked_mse=0.0261842; img_mse=0.00771856; img_visible_l1=8.09326e-05; img_visible_mse=8.09307e-09; pair_l2=0.345003; pix_var=0.0609264; psnr=22.7569; ssim=0.954641 |
| no_causal | `clean_aud_only` | 10000 | acc=0.9883; aud_mse=0.00364809; aud_ssim=0.911157; content_aud_normal_acc=0.96; content_img_normal_acc=0.9771; img_coarse_masked_mse=0.00208492; img_masked_l1=0.00749103; img_masked_mse=0.00208492; img_mse=0.00208492; pair_l2=0.285814; pix_var=0.0462463; psnr=36.8851; ssim=0.985614 |
| no_causal | `clean_img_only` | 10000 | acc=0.977; aud_masked_l1=0.00356523; aud_masked_mse=0.00029628; aud_mse=0.00029628; aud_ssim=0.966043; content_aud_normal_acc=0.9448; content_img_normal_acc=0.9682; img_mse=0.00977739; pair_l2=0.339948; pix_var=0.0593863; psnr=20.7714; ssim=0.942646 |
| no_causal | `clean_both` | 10000 | acc=0.9918; aud_mse=0.00364344; aud_ssim=0.911253; content_aud_normal_acc=0.9604; content_img_normal_acc=0.9779; img_mse=0.00973233; pair_l2=0.33994; pix_var=0.0588506; psnr=20.7941; ssim=0.942685 |
| no_causal | `clean_img_corrupt_aud` | 10000 | acc=0.9896; aud_masked_l1=0.0293132; aud_masked_mse=0.00967485; aud_mse=0.00577848; aud_ssim=0.818126; aud_visible_l1=0.0137003; aud_visible_mse=0.00320552; content_aud_normal_acc=0.9004; content_img_normal_acc=0.975; img_mse=0.00978341; pair_l2=0.341653; pix_var=0.0592846; psnr=20.7705; ssim=0.942602 |
| no_causal | `corrupt_aud_only` | 10000 | acc=0.8579; aud_masked_l1=0.0295669; aud_masked_mse=0.0103806; aud_mse=0.00605548; aud_ssim=0.813113; aud_visible_l1=0.0137038; aud_visible_mse=0.00320732; content_aud_normal_acc=0.8177; content_img_normal_acc=0.8408; img_coarse_masked_mse=0.0114554; img_masked_l1=0.0242846; img_masked_mse=0.0114554; img_mse=0.0114554; pair_l2=0.271634; pix_var=0.0403578; psnr=30.8263; ssim=0.89987 |
| no_causal | `corrupt_img_clean_aud` | 10000 | acc=0.9916; aud_mse=0.00364718; aud_ssim=0.911193; content_aud_normal_acc=0.96; content_img_normal_acc=0.9672; img_coarse_masked_mse=0.0585328; img_coarse_visible_mse=0.0286298; img_masked_l1=0.0666687; img_masked_mse=0.0275689; img_mse=0.00726706; img_visible_l1=8.14308e-05; img_visible_mse=8.14291e-09; pair_l2=0.345697; pix_var=0.0610109; psnr=23.0473; ssim=0.957267 |
| no_causal | `corrupt_img_only` | 10000 | acc=0.9236; aud_masked_l1=0.00516904; aud_masked_mse=0.000631792; aud_mse=0.000631792; aud_ssim=0.922205; content_aud_normal_acc=0.8478; content_img_normal_acc=0.9549; img_coarse_masked_mse=0.0607087; img_coarse_visible_mse=0.0291008; img_masked_l1=0.0689266; img_masked_mse=0.0292326; img_mse=0.00761429; img_visible_l1=8.14308e-05; img_visible_mse=8.14291e-09; pair_l2=0.345536; pix_var=0.0609478; psnr=22.8654; ssim=0.955219 |
| no_causal | `corrupt_both` | 10000 | acc=0.9728; aud_masked_l1=0.028584; aud_masked_mse=0.00969885; aud_mse=0.00584889; aud_ssim=0.822521; aud_visible_l1=0.0141385; aud_visible_mse=0.00331514; content_aud_normal_acc=0.8762; content_img_normal_acc=0.9631; img_coarse_masked_mse=0.0538351; img_coarse_visible_mse=0.0306974; img_masked_l1=0.0627044; img_masked_mse=0.0257599; img_mse=0.00761957; img_visible_l1=8.09326e-05; img_visible_mse=8.09307e-09; pair_l2=0.344707; pix_var=0.0608293; psnr=22.8089; ssim=0.955153 |

### Cross-Key sweep����ʵ�顢��Э�顢ȫ�����ø�Ԥָ��

`aud2img` ����Ƶ Key ����ͼ��ָ���`img2aud` ��ͼ�� Key ������Ƶ�ָ���normal/zero/wrong Ϊȱʧ���� MSE��gain Ϊ zero-normal��win_* Ϊ������ʤ��������gate/ratio Ϊ�������

#### fixed_mask sweep
| ʵ�� | cue | n | metrics |
|---|---|---:|---|
| main | `clean_img_corrupt_aud` | 10000/9996 | img2aud_normal_mse=0.0101281; img2aud_zero_mse=0.0105994; img2aud_wrong_mse=0.0101433; img2aud_same_class_mse=0.0101269; img2aud_correct_gain=0.000471262; img2aud_wrong_damage=1.51783e-05; img2aud_same_damage=-2.14807e-06; img2aud_win_zero=0.6703; img2aud_win_wrong=0.4361; img2aud_win_both=0.36314; img2aud_gate=0.947075; img2aud_ratio=0.0154647 |
| main | `corrupt_aud_only` | 10000/9996 | aud2img_normal_mse=0.0127563; aud2img_zero_mse=0.0132116; aud2img_wrong_mse=0.0127397; aud2img_same_class_mse=0.0127341; aud2img_correct_gain=0.000455322; aud2img_wrong_damage=-1.65784e-05; aud2img_same_damage=-2.21893e-05; aud2img_win_zero=0.53986; aud2img_win_wrong=0.57434; aud2img_win_both=0.33558; aud2img_gate=0.53581; aud2img_ratio=0.349206 |
| main | `corrupt_both` | 10000/9996 | aud2img_normal_mse=0.0253559; aud2img_zero_mse=0.0259124; aud2img_wrong_mse=0.0253817; aud2img_same_class_mse=0.025343; aud2img_correct_gain=0.000556571; aud2img_wrong_damage=2.58341e-05; aud2img_same_damage=-7.7751e-06; aud2img_win_zero=0.67536; aud2img_win_wrong=0.49806; aud2img_win_both=0.36534; aud2img_gate=0.563012; aud2img_ratio=0.185046; img2aud_normal_mse=0.0104162; img2aud_zero_mse=0.0107748; img2aud_wrong_mse=0.010423; img2aud_same_class_mse=0.010417; img2aud_correct_gain=0.000358586; img2aud_wrong_damage=6.71521e-06; img2aud_same_damage=5.45694e-07; img2aud_win_zero=0.6774; img2aud_win_wrong=0.43006; img2aud_win_both=0.35866; img2aud_gate=0.944893; img2aud_ratio=0.0123245 |
| main | `corrupt_img_clean_aud` | 10000/9996 | aud2img_normal_mse=0.0252635; aud2img_zero_mse=0.025918; aud2img_wrong_mse=0.0253069; aud2img_same_class_mse=0.0252635; aud2img_correct_gain=0.000654565; aud2img_wrong_damage=4.33945e-05; aud2img_same_damage=1.77263e-06; aud2img_win_zero=0.68372; aud2img_win_wrong=0.5232; aud2img_win_both=0.38102; aud2img_gate=0.563705; aud2img_ratio=0.231 |
| main | `clean_img_only` | 10000/9996 | img2aud_normal_mse=0.000294015; img2aud_zero_mse=0.000289205; img2aud_wrong_mse=0.00030387; img2aud_same_class_mse=0.000294845; img2aud_correct_gain=-4.8098e-06; img2aud_wrong_damage=9.8546e-06; img2aud_same_damage=7.58809e-07; img2aud_win_zero=0.3519; img2aud_win_wrong=0.6926; img2aud_win_both=0.268; img2aud_gate=0.947892; img2aud_ratio=0.040982 |
| main | `corrupt_img_only` | 10000/9996 | img2aud_normal_mse=0.000670174; img2aud_zero_mse=0.00066839; img2aud_wrong_mse=0.000675043; img2aud_same_class_mse=0.000671726; img2aud_correct_gain=-1.78366e-06; img2aud_wrong_damage=4.86932e-06; img2aud_same_damage=1.53027e-06; img2aud_win_zero=0.32878; img2aud_win_wrong=0.66106; img2aud_win_both=0.23774; img2aud_gate=0.946077; img2aud_ratio=0.032254 |
| control | `clean_img_corrupt_aud` | 10000/9996 | img2aud_normal_mse=0.0105994; img2aud_zero_mse=0.0105994; img2aud_wrong_mse=0.0105994; img2aud_same_class_mse=0.0106004; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| control | `corrupt_aud_only` | 10000/9996 | aud2img_normal_mse=0.0132116; aud2img_zero_mse=0.0132116; aud2img_wrong_mse=0.0132116; aud2img_same_class_mse=0.0132116; aud2img_correct_gain=0; aud2img_wrong_damage=0; aud2img_same_damage=0; aud2img_win_zero=0; aud2img_win_wrong=0; aud2img_win_both=0; aud2img_ratio=0 |
| control | `corrupt_both` | 10000/9996 | aud2img_normal_mse=0.0259124; aud2img_zero_mse=0.0259124; aud2img_wrong_mse=0.0259124; aud2img_same_class_mse=0.0259069; aud2img_correct_gain=0; aud2img_wrong_damage=0; aud2img_same_damage=0; aud2img_win_zero=0; aud2img_win_wrong=0; aud2img_win_both=0; aud2img_ratio=0; img2aud_normal_mse=0.0107748; img2aud_zero_mse=0.0107748; img2aud_wrong_mse=0.0107748; img2aud_same_class_mse=0.0107751; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| control | `corrupt_img_clean_aud` | 10000/9996 | aud2img_normal_mse=0.025918; aud2img_zero_mse=0.025918; aud2img_wrong_mse=0.025918; aud2img_same_class_mse=0.0259162; aud2img_correct_gain=0; aud2img_wrong_damage=0; aud2img_same_damage=0; aud2img_win_zero=0; aud2img_win_wrong=0; aud2img_win_both=0; aud2img_ratio=0 |
| control | `clean_img_only` | 10000/9996 | img2aud_normal_mse=0.000289205; img2aud_zero_mse=0.000289205; img2aud_wrong_mse=0.000289205; img2aud_same_class_mse=0.000289275; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| control | `corrupt_img_only` | 10000/9996 | img2aud_normal_mse=0.00066839; img2aud_zero_mse=0.00066839; img2aud_wrong_mse=0.00066839; img2aud_same_class_mse=0.000668409; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| no_causal | `clean_img_corrupt_aud` | 10000/9996 | img2aud_normal_mse=0.0103113; img2aud_zero_mse=0.0105994; img2aud_wrong_mse=0.010393; img2aud_same_class_mse=0.0103103; img2aud_correct_gain=0.000288108; img2aud_wrong_damage=8.17303e-05; img2aud_same_damage=-1.69492e-06; img2aud_win_zero=0.54438; img2aud_win_wrong=0.45348; img2aud_win_both=0.3289; img2aud_gate=0.959665; img2aud_ratio=0.0110534 |
| no_causal | `corrupt_aud_only` | 10000/9996 | aud2img_normal_mse=0.012351; aud2img_zero_mse=0.0132116; aud2img_wrong_mse=0.0126062; aud2img_same_class_mse=0.0125769; aud2img_correct_gain=0.000860603; aud2img_wrong_damage=0.00025513; aud2img_same_damage=0.000225803; aud2img_win_zero=0.44568; aud2img_win_wrong=0.61516; aud2img_win_both=0.32076; aud2img_gate=0.760346; aud2img_ratio=0.176541 |
| no_causal | `corrupt_both` | 10000/9996 | aud2img_normal_mse=0.025528; aud2img_zero_mse=0.0259124; aud2img_wrong_mse=0.025601; aud2img_same_class_mse=0.0255145; aud2img_correct_gain=0.000384418; aud2img_wrong_damage=7.29201e-05; aud2img_same_damage=-8.66288e-06; aud2img_win_zero=0.60966; aud2img_win_wrong=0.50236; aud2img_win_both=0.35632; aud2img_gate=0.749693; aud2img_ratio=0.0879271; img2aud_normal_mse=0.0105583; img2aud_zero_mse=0.0107748; img2aud_wrong_mse=0.0106055; img2aud_same_class_mse=0.010558; img2aud_correct_gain=0.000216496; img2aud_wrong_damage=4.72001e-05; img2aud_same_damage=-3.95497e-07; img2aud_win_zero=0.54652; img2aud_win_wrong=0.44612; img2aud_win_both=0.32084; img2aud_gate=0.957989; img2aud_ratio=0.00875489 |
| no_causal | `corrupt_img_clean_aud` | 10000/9996 | aud2img_normal_mse=0.0254411; aud2img_zero_mse=0.025918; aud2img_wrong_mse=0.025544; aud2img_same_class_mse=0.0254423; aud2img_correct_gain=0.000476895; aud2img_wrong_damage=0.000102857; aud2img_same_damage=2.78659e-06; aud2img_win_zero=0.61138; aud2img_win_wrong=0.52908; aud2img_win_both=0.36356; aud2img_gate=0.746061; aud2img_ratio=0.0916768 |
| no_causal | `clean_img_only` | 10000/9996 | img2aud_normal_mse=0.00029628; img2aud_zero_mse=0.000289205; img2aud_wrong_mse=0.000324157; img2aud_same_class_mse=0.000300605; img2aud_correct_gain=-7.07502e-06; img2aud_wrong_damage=2.7877e-05; img2aud_same_damage=4.25411e-06; img2aud_win_zero=0.2851; img2aud_win_wrong=0.7118; img2aud_win_both=0.2337; img2aud_gate=0.961301; img2aud_ratio=0.0277242 |
| no_causal | `corrupt_img_only` | 10000/9996 | img2aud_normal_mse=0.00067383; img2aud_zero_mse=0.00066839; img2aud_wrong_mse=0.00068723; img2aud_same_class_mse=0.000682651; img2aud_correct_gain=-5.43964e-06; img2aud_wrong_damage=1.33999e-05; img2aud_same_damage=8.79821e-06; img2aud_win_zero=0.38516; img2aud_win_wrong=0.65556; img2aud_win_both=0.27536; img2aud_gate=0.960106; img2aud_ratio=0.0215934 |
#### legacy_random sweep
| ʵ�� | cue | n | metrics |
|---|---|---:|---|
| main | `clean_img_corrupt_aud` | 10000/9996 | img2aud_normal_mse=0.00948602; img2aud_zero_mse=0.00992893; img2aud_wrong_mse=0.00949466; img2aud_same_class_mse=0.00947649; img2aud_correct_gain=0.000442905; img2aud_wrong_damage=8.63835e-06; img2aud_same_damage=-2.38046e-06; img2aud_win_zero=0.6931; img2aud_win_wrong=0.4369; img2aud_win_both=0.3678; img2aud_gate=0.946372; img2aud_ratio=0.0172098 |
| main | `corrupt_aud_only` | 10000/9996 | aud2img_normal_mse=0.0118108; aud2img_zero_mse=0.0122087; aud2img_wrong_mse=0.0117998; aud2img_same_class_mse=0.0117784; aud2img_correct_gain=0.000397847; aud2img_wrong_damage=-1.10194e-05; aud2img_same_damage=-1.59234e-05; aud2img_win_zero=0.5286; aud2img_win_wrong=0.5704; aud2img_win_both=0.332; aud2img_gate=0.535583; aud2img_ratio=0.352793 |
| main | `corrupt_both` | 10000/9996 | aud2img_normal_mse=0.0256151; aud2img_zero_mse=0.0261842; aud2img_wrong_mse=0.0256333; aud2img_same_class_mse=0.0255806; aud2img_correct_gain=0.000569115; aud2img_wrong_damage=1.81695e-05; aud2img_same_damage=-1.11663e-05; aud2img_win_zero=0.6698; aud2img_win_wrong=0.4991; aud2img_win_both=0.3625; aud2img_gate=0.563208; aud2img_ratio=0.188709; img2aud_normal_mse=0.00958116; img2aud_zero_mse=0.00991035; img2aud_wrong_mse=0.00958435; img2aud_same_class_mse=0.00957197; img2aud_correct_gain=0.000329194; img2aud_wrong_damage=3.18721e-06; img2aud_same_damage=-1.95826e-06; img2aud_win_zero=0.6635; img2aud_win_wrong=0.4187; img2aud_win_both=0.353; img2aud_gate=0.946352; img2aud_ratio=0.01224 |
| main | `corrupt_img_clean_aud` | 10000/9996 | aud2img_normal_mse=0.0274295; aud2img_zero_mse=0.0282621; aud2img_wrong_mse=0.0274446; aud2img_same_class_mse=0.0274081; aud2img_correct_gain=0.000832641; aud2img_wrong_damage=1.51393e-05; aud2img_same_damage=-3.41688e-06; aud2img_win_zero=0.7096; aud2img_win_wrong=0.519; aud2img_win_both=0.3873; aud2img_gate=0.562402; aud2img_ratio=0.217568 |
| main | `clean_img_only` | 10000/9996 | img2aud_normal_mse=0.000294015; img2aud_zero_mse=0.000289205; img2aud_wrong_mse=0.00030387; img2aud_same_class_mse=0.000294845; img2aud_correct_gain=-4.8098e-06; img2aud_wrong_damage=9.8546e-06; img2aud_same_damage=7.58809e-07; img2aud_win_zero=0.3519; img2aud_win_wrong=0.6926; img2aud_win_both=0.268; img2aud_gate=0.947892; img2aud_ratio=0.040982 |
| main | `corrupt_img_only` | 10000/9996 | img2aud_normal_mse=0.000629427; img2aud_zero_mse=0.000627487; img2aud_wrong_mse=0.00063492; img2aud_same_class_mse=0.000631264; img2aud_correct_gain=-1.93981e-06; img2aud_wrong_damage=5.49293e-06; img2aud_same_damage=1.7539e-06; img2aud_win_zero=0.3309; img2aud_win_wrong=0.6676; img2aud_win_both=0.2409; img2aud_gate=0.946163; img2aud_ratio=0.0323025 |
| control | `clean_img_corrupt_aud` | 10000/9996 | img2aud_normal_mse=0.00992893; img2aud_zero_mse=0.00992893; img2aud_wrong_mse=0.00992893; img2aud_same_class_mse=0.00992173; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| control | `corrupt_aud_only` | 10000/9996 | aud2img_normal_mse=0.0122087; aud2img_zero_mse=0.0122087; aud2img_wrong_mse=0.0122087; aud2img_same_class_mse=0.0121914; aud2img_correct_gain=0; aud2img_wrong_damage=0; aud2img_same_damage=0; aud2img_win_zero=0; aud2img_win_wrong=0; aud2img_win_both=0; aud2img_ratio=0 |
| control | `corrupt_both` | 10000/9996 | aud2img_normal_mse=0.0261842; aud2img_zero_mse=0.0261842; aud2img_wrong_mse=0.0261842; aud2img_same_class_mse=0.0261592; aud2img_correct_gain=0; aud2img_wrong_damage=0; aud2img_same_damage=0; aud2img_win_zero=0; aud2img_win_wrong=0; aud2img_win_both=0; aud2img_ratio=0; img2aud_normal_mse=0.00991035; img2aud_zero_mse=0.00991035; img2aud_wrong_mse=0.00991035; img2aud_same_class_mse=0.00990307; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| control | `corrupt_img_clean_aud` | 10000/9996 | aud2img_normal_mse=0.0282621; aud2img_zero_mse=0.0282621; aud2img_wrong_mse=0.0282621; aud2img_same_class_mse=0.028243; aud2img_correct_gain=0; aud2img_wrong_damage=0; aud2img_same_damage=0; aud2img_win_zero=0; aud2img_win_wrong=0; aud2img_win_both=0; aud2img_ratio=0 |
| control | `clean_img_only` | 10000/9996 | img2aud_normal_mse=0.000289205; img2aud_zero_mse=0.000289205; img2aud_wrong_mse=0.000289205; img2aud_same_class_mse=0.000289275; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| control | `corrupt_img_only` | 10000/9996 | img2aud_normal_mse=0.000627487; img2aud_zero_mse=0.000627487; img2aud_wrong_mse=0.000627487; img2aud_same_class_mse=0.000627567; img2aud_correct_gain=0; img2aud_wrong_damage=0; img2aud_same_damage=0; img2aud_win_zero=0; img2aud_win_wrong=0; img2aud_win_both=0; img2aud_ratio=0 |
| no_causal | `clean_img_corrupt_aud` | 10000/9996 | img2aud_normal_mse=0.00967485; img2aud_zero_mse=0.00992893; img2aud_wrong_mse=0.00973957; img2aud_same_class_mse=0.00965869; img2aud_correct_gain=0.00025408; img2aud_wrong_damage=6.47281e-05; img2aud_same_damage=-8.11767e-06; img2aud_win_zero=0.5591; img2aud_win_wrong=0.4474; img2aud_win_both=0.3211; img2aud_gate=0.958783; img2aud_ratio=0.012209 |
| no_causal | `corrupt_aud_only` | 10000/9996 | aud2img_normal_mse=0.0114554; aud2img_zero_mse=0.0122087; aud2img_wrong_mse=0.0116782; aud2img_same_class_mse=0.0116575; aud2img_correct_gain=0.000753288; aud2img_wrong_damage=0.000222771; aud2img_same_damage=0.000217364; aud2img_win_zero=0.4356; aud2img_win_wrong=0.6104; aud2img_win_both=0.3142; aud2img_gate=0.760123; aud2img_ratio=0.174541 |
| no_causal | `corrupt_both` | 10000/9996 | aud2img_normal_mse=0.0257599; aud2img_zero_mse=0.0261842; aud2img_wrong_mse=0.0258375; aud2img_same_class_mse=0.0257307; aud2img_correct_gain=0.000424329; aud2img_wrong_damage=7.75661e-05; aud2img_same_damage=-8.13094e-06; aud2img_win_zero=0.6021; aud2img_win_wrong=0.5177; aud2img_win_both=0.3587; aud2img_gate=0.748743; aud2img_ratio=0.0869828; img2aud_normal_mse=0.00969885; img2aud_zero_mse=0.00991035; img2aud_wrong_mse=0.00973529; img2aud_same_class_mse=0.00968536; img2aud_correct_gain=0.000211504; img2aud_wrong_damage=3.64464e-05; img2aud_same_damage=-5.60173e-06; img2aud_win_zero=0.533; img2aud_win_wrong=0.4259; img2aud_win_both=0.3047; img2aud_gate=0.959606; img2aud_ratio=0.00870458 |
| no_causal | `corrupt_img_clean_aud` | 10000/9996 | aud2img_normal_mse=0.0275689; aud2img_zero_mse=0.0282621; aud2img_wrong_mse=0.0276476; aud2img_same_class_mse=0.0275498; aud2img_correct_gain=0.00069324; aud2img_wrong_damage=7.86869e-05; aud2img_same_damage=-1.61915e-06; aud2img_win_zero=0.6422; aud2img_win_wrong=0.5318; aud2img_win_both=0.3806; aud2img_gate=0.740382; aud2img_ratio=0.0864941 |
| no_causal | `clean_img_only` | 10000/9996 | img2aud_normal_mse=0.00029628; img2aud_zero_mse=0.000289205; img2aud_wrong_mse=0.000324157; img2aud_same_class_mse=0.000300605; img2aud_correct_gain=-7.07502e-06; img2aud_wrong_damage=2.7877e-05; img2aud_same_damage=4.25411e-06; img2aud_win_zero=0.2851; img2aud_win_wrong=0.7118; img2aud_win_both=0.2337; img2aud_gate=0.961301; img2aud_ratio=0.0277242 |
| no_causal | `corrupt_img_only` | 10000/9996 | img2aud_normal_mse=0.000631792; img2aud_zero_mse=0.000627487; img2aud_wrong_mse=0.000645864; img2aud_same_class_mse=0.000640851; img2aud_correct_gain=-4.30508e-06; img2aud_wrong_damage=1.40719e-05; img2aud_same_damage=8.97126e-06; img2aud_win_zero=0.3799; img2aud_win_wrong=0.6612; img2aud_win_both=0.2801; img2aud_gate=0.960165; img2aud_ratio=0.021626 |

### Audio family breakdown

`audio_family_breakdown_fixed.csv` ��ÿ��ʵ�鱣�� 15 �� cue/family ��ϼ�ȫ���ֶΣ�`acc, img_mse, psnr, img_ssim, aud_mse, aud_ssim, aud_masked_mse, aud_masked_l1, aud_visible_mse, aud_visible_l1, rec_std, tgt_std, top15_recall`��ԭʼ������Ϊ��

- `v11g_outputs/outputs/outputs_v11g/tables/audio_family_breakdown_fixed.csv`
- `v11g_outputs/outputs/outputs_v11g_control/tables/audio_family_breakdown_fixed.csv`
- `v11g_outputs/outputs/outputs_v11g_no_causal/tables/audio_family_breakdown_fixed.csv`

����� family ����һ�£�`partial_temporal` �� audio-only ACC=0.4588��audio MSE Լ 0.0126��SSIM Լ 0.60��top15 recall Լ 0.686������ audio-only family ACC=0.9039--0.9710��top15 recall=0.7787--0.8163������ֻ����һ�� audio ƽ��ֵ��

### ����ж�

1. **ѵ�����������������** ���� checkpoint��fixed/random normal��Cross-Key sweep��family breakdown �� fixed/random demo �����ڣ���־û�� NaN �� CUDA ����main/no-causal ĩ��ƽ�� loss �ֱ�Ϊ 0.8213 �� 0.7790��
2. **��������û���� v11g ѵ��Ư�ơ�** fixed ������ Index ACC ������ cue ��ȫһ�£�clean_aud_only 98.83%��clean_img_only 97.70%��clean_both 99.18%��clean_img_corrupt_aud 98.93%��corrupt_aud_only 84.57%��corrupt_img_clean_aud 99.14%��corrupt_img_only 92.03%��corrupt_both 97.54%��
3. **Cross-Key �оֲ������棬�����ѡ����������** main fixed �У�audio Key->image �� corrupt_aud_only �� masked MSE Ϊ 0.013212->0.012756��gain=0.000455��win_zero=53.99%��image Key->audio �� clean_img_corrupt_aud Ϊ 0.010599->0.010128��gain=0.000471��win_zero=67.03%���� win_both ֻ��Լ 33.56% �� 36.31%��same-class ���˽ӽ� 0���в���֤����ȷ��� Key �ȶ����� zero/wrong��
4. **causal margin Ч�������Ҳ��ȶ���** no-causal fixed �� audio Key->image/corrupt_aud_only �� gain=0.0009��win_zero=44.57%������ main���� image Key->audio/clean_img_corrupt_aud �� gain=0.0003��win_zero=54.44%��Ҳ���� main���� main �� wrong_damage �Խӽ� 0���������� causal �ѽ�����ѡ�����⡣
5. **�ָ�������������ȱ�Ѷ�������Ƶ��** main fixed �� corrupt_aud_only audio MSE=0.006290��masked MSE=0.011079��SSIM=0.804689��corrupt_both audio MSE=0.006041��SSIM=0.807610��ͼ�� corrupt_img_only �� masked MSE=0.026662��corrupt_both=0.025356��visible MSE ԼΪ 0��˵���ɼ���������Ч����Ҫ�����ȱʧ����
6. **fixed �� random ����һ�µ���ֵ���ɻ�ϡ�** random �� main �� corrupt_aud_only ACC=85.79%��audio MSE=0.006055��SSIM=0.813113��corrupt_both ACC=97.28%��audio MSE=0.005849��SSIM=0.822521��random ʹ�ö��� seed ���� mask���ʺ�³���Գ�飬���� fixed ��ͬһ��������

### ����ʵ�����������

- **main (`v11g`)**���������;ֲ� decoder-feature Cross-Key ����ƹ���������С�� masked recovery ���ƣ��� win_both��wrong damage �� same-class ���ղ�����֤��ǿ���ѡ���ԡ�
- **control (`v11g_control`)**����ͨ·���Ḹģ�ͣ��ṩ����ͻָ��ο������ǵ�Ԥ����ѵ control��
- **no-causal (`v11g_no_causal`)**���ر� causal margin ������С��������˵�� adapter ��������һ���֣��� main �Ĳ���ɹ����� causal loss���� causal ��ȫ��ָ��û��һ��������

���ƣ������ǵ� seed��severity=0.4��30 �֣�normal ���ǿ� family ��ƽ�����޶� seed �������䣬Ҳû�� v11f ͬ�������ܣ���˲������� v11g ��� v11f ���ϸ�ͳ��������������һ�汾Ӧ���ȴ��� Cross-Key ���ѡ���ԣ�������ֻ���� decoder ��ֻ��ȫ�� MSE��
