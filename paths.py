...
目录约定：
  ...
  outputs/outputs_v8/figures/   当前版本专属图表
  outputs/outputs_v8/logs/
  outputs/outputs_v8/tables/
"""
...
DEFAULT_CONFIG = CONFIGS_DIR / "v8.yaml"


def _normalize_version_folder(tag):
    """'v8' / '8' / 'outputs_v8' -> 'outputs_v8'。"""
    tag = str(tag).strip()
